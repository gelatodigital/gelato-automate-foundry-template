...
import
  "../../../src/contractCreator/withTreasury/CounterSingleExecTaskCreator.sol";
...
contract CounterTest is Test, Gelato {
  CounterSingleExecTaskCreator public counter;
  ...
  function setUp() public {
    counter = new CounterSingleExecTaskCreator(payable(automate), user1);
  }
