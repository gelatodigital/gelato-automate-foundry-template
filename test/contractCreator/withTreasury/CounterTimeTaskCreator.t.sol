...
import "../../../src/contractCreator/withTreasury/CounterTimeTaskCreator.sol";
...
contract CounterTest is Test, Gelato {
  CounterTimeTaskCreator public counter;
  ...
  function setUp() public {
    counter = new CounterTimeTaskCreator(payable(automate), user1);
  }
