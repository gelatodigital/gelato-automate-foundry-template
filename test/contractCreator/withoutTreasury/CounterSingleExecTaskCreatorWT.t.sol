...
import
  "../../../src/contractCreator/withoutTreasury/CounterSingleExecTaskCreatorWT.sol";
...
contract CounterTest is Test, Gelato {
  CounterSingleExecTaskCreatorWT public counter;
  ...
  function setUp() public {
    counter = new CounterSingleExecTaskCreatorWT(payable(automate), user1);
  }
